package com.valhalla.meusfilmes.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.valhalla.meusfilmes.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.valhalla.meusfilmes.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.valhalla.meusfilmes.config.dbmigrations");
